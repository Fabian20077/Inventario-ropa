...
-- Usuario admin con password: password123 (BCrypt hash)
INSERT INTO usuario (nombre, correo, password, rol_id) VALUES 
('Admin', 'admin@mv.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 1),
('Gerente Demo', 'gerente@mv.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 2);
